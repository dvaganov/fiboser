...
type FibonacciClient interface {
	GetRange(ctx context.Context, in *FibonacciRangeRequest, opts ...grpc.CallOption) (*FibonacciRangeResponse, error)
}
...
func (c *fibonacciClient) GetRange(ctx context.Context, in *FibonacciRangeRequest, opts ...grpc.CallOption) (*FibonacciRangeResponse, error) {
	out := new(FibonacciRangeResponse)
	err := c.cc.Invoke(ctx, "/fibogrpc.Fibonacci/GetRange", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FibonacciServer interface {
	GetRange(context.Context, *FibonacciRangeRequest) (*FibonacciRangeResponse, error)
...
func (UnimplementedFibonacciServer) GetRange(context.Context, *FibonacciRangeRequest) (*FibonacciRangeResponse, error) {
...
func _Fibonacci_GetRange_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FibonacciRangeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FibonacciServer).GetRange(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fibogrpc.Fibonacci/GetRange",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FibonacciServer).GetRange(ctx, req.(*FibonacciRangeRequest))
	}
...
var Fibonacci_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fibogrpc.Fibonacci",
	HandlerType: (*FibonacciServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetRange",
			Handler:    _Fibonacci_GetRange_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/fibo.proto",
}
